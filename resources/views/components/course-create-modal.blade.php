    ...
    >
        ...
        >
            ...
            <form action="{{ route('course.store') }}" method="POST" class="space-y-4">
                ...
                <div>
                    <label class="block text-sm text-orange-600 mb-1 font-medium">Nombre del curso</label>
                ...
                <div>
                    <label class="block text-sm text-orange-600 mb-1 font-medium">Descripción</label>
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        <label class="block text-sm text-orange-600 mb-1 font-medium">Modalidad</label>
                    ...
                    <div>
                        <label class="block text-sm text-orange-600 mb-1 font-medium">Tipo evento</label>
